        ...
        <div className="controls">
          ...
          <div className="controls">
            <div
              ...
              style={{ display: "flex", cursor: "pointer",flexDirection: "row", justifyContent:"space-between", width: "90px", height: "55px"}}
            >
              <input
                style={{ margin: "0.5em 0.2em", width: "20px", height: "20px"}}
                // className="settings-control"
                type="checkbox"
                value={this.state.sdvg}
                onClick={()=>{this.setState({sdvg: !this.state.sdvg})}}/>
              <div style={{ margin: "0.1em 0em" }}>СДВГ</div>
            </div>
          </div>
        </div>
